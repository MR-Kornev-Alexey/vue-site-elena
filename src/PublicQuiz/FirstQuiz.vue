  ...
  <v-container fluid id="first-quiz">
    <v-row class="row-blue d-flex justify-center text-center mt-4">
      <v-col
        cols="11" md="8"
      >
        <h2 class="h2-title">Анкета участника</h2>
      </v-col>
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter === 1">
      ...
      >
        <div class="text-left p-quiz-text">
          ...
          <p class="">
            Я рада, что Вы решили вступить в состязание и отстоять честь своего пола
          </p>
          <p class="">
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter < 12">
      <v-col
        cols="11" md="5"
        class="d-flex justify-center"
      >
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter === 2">
      <v-col
        cols="11" md="5"
        class="d-flex justify-center"
      >
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter === 3">
      <v-col
        cols="11" md="3"
        class="d-flex justify-center" style="flex-direction: column"
      >
      <div
        v-for="n in questionsParents"
        :key="n.id"
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter === 4">
      <v-col
        cols="11" md="5"
        class="d-flex justify-center"
      >
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter === 7">
      <v-col
        cols="11" md="5"
        class="d-flex justify-center"
      >
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter === 9">
      <v-col
        cols="11" md="5"
        class="d-flex justify-center"
      >
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter === 10">
      <v-col
        cols="11" md="5"
        class="d-flex justify-center"
      >
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter === 11">
      <v-col
        cols="11" md="5"
        class="d-flex justify-center"
      >
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter === 5 || counter === 6 || counter === 8">
      <v-col
        cols="11" md="3"
        class="d-flex justify-center" style="flex-direction: column"
      >
      <div
        v-for="n in questions3"
        :key="n.id"
        class="mb-6 d-flex justify-center pt-3 mx-auto"
        @click="selectRadio(n.id)"
        :class="classObject(n.id)"
    ...
    <v-row class="row-light d-flex justify-center text-center py-4" v-if="counter < 12">
      ...
      >
        <v-btn
            class="btn-dream-small-blue mx-auto" :disabled="!access" @click="nextPage"
          >
            дальше
          </v-btn>
