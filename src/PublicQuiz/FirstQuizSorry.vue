  ...
  <v-container fluid id="first-quiz">
    <v-row class="row-blue d-flex justify-center text-center pt-4">
      <v-col
        cols="11" md="8"
      >
        <h2 class="h2-title">Анктирование по речевому развитию закончено</h2>
        <v-img
    ...
    <v-row class="row-blue d-flex justify-center text-center pt-4">
      <v-col
        cols="11" md="7"
      >
        <h3 class="">Вы можете принять участие в бесплатном вебинаре<br><strong>"НЕ говорит! Эффективные стратегии
          развития речи"</strong></h3>
        <p>Он состоится 11 июля 2023 года. Время и ссылка на вебинар будут присланы ближе к дате</p>
      </v-col>
    </v-row>
    <v-row class="row-blue d-flex justify-center text-center pt-4">
      <v-col
        cols="11" md="7"
      >
        <a href="https://t.me/commonHelenBot" target="_blank">
