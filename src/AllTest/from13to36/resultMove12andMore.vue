  ...
  computed: {
    ...
    resultIfTest () {
      ...
      if (sumNew >= 0 && sumNew <= 25) {
        return resultTestAll.theAnswersMove[2]
      } else if (sumNew > 25 && sumNew <= 75) {
        return resultTestAll.theAnswersMove[1]
      } else {
        return resultTestAll.theAnswersMove[0]
      }
    },
    numberMonthForTest () {
      return this.$store.state.auth.currentMonthNew
    ...
    resultMoveTest () {
      return this.$store.state.allTest.monthMoveOfTest[2]
    },
    checkMoveTest () {
